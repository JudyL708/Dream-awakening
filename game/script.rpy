...
label punishment:
    ...
    menu:
        "真的要退出吗？但刚刚你可是帮了大忙啊，我们都很需要你哦！":
            jump punishment_quit
        "那就继续出发吧！":
            jump punishment_keep_going

label punishment_quit:
...
label punishment_b:
    ...
    b"别傻站着！跟着探梦者跑！"
    jump pass #抱歉，not sure (f)是什么意思，没对上号啊啊啊
